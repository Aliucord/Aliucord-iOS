      ...
      const aliucordSection = 
        ...
        <FormSection>
          <FormRow label={<FormLabel style={{color: "#6e5494"}} text={"GitHub"}/>} trailing={<FormArrow/>} onPress={() => {
            openURL("https://github.com/Aliucord/Aliucord-iOS");
          }}></FormRow>
          <FormDivider />
          ...
          <FormDivider />
          <FormRow label={<FormLabel style={{color: "#00C853"}} text={"Discord"}/>} trailing={<FormArrow/>} onPress={() => {
            openURL("https://discord.gg/aliucord");
          }}></FormRow>
        </FormSection></>;
